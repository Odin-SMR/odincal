...
The odincal package contains basically of two parts of code.
One part of codes control and performs the processing
and the second part of codes are used for reading level0-files. 

Source codes to the programs controling the processing are
found in directory 
\begin{verbatim}
odincal/odincal/odincal

#import of filenames
level0_file_importer.py
test_serv.py

#import of level0 data
level0.py

#import of level1 data
ac_level1a_importer.py
att_level1_importer.py
shk_level1_importer.py

#control of calibration
level1b_window_importer2.py
frequency_calibration.py
intensity_calibration.py
calibration_preprocess.py

#import af average calibrated data
ac_average_data_import.py
ac_average_datafit_import.p

#processing control
process_level0_or_calibrate.py
logserver.py

#export of data
level1b_exporter_32.py
level1b_exporter_hdf5.py
level1b_exporter_matlab.m


\end{verbatim}


Source codes used (by odincal/odincal/odincal/level0.py) for reading 
level0-files are found
in directory  
\begin{verbatim}
odincal/develop-eggs/pyodin-1.2.3gem-py2.7-linux-x86_64.egg/odin

attitude.py #attitude file
level0.py #ACfile,FBAfile, and SHKfile
\end{verbatim}
